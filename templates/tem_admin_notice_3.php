                ...
                <form action='../php_config/db_admin_notice_3.php' method='POST'>
                    <table class='main-table'>
                        <tr>
                            ...
                            <td><input type='text' id='login' class='input_1' name='board_id' placeholder="Notice Id">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><input type='text' id='login' class='input_1' name='board_desc'
                                    style='height:200px; width:100%' placeholder="Description"></td>
