<?php
    ...
    if(isset($_POST['REGISTER']))
    {
        if(isset($_SESSION['teacher_id_value']))
        {
            ...
            $sql = "update teacher_info set teacher_id='$teacher_id',teacher_name='$teacher_name', teacher_phone='$teacher_phone',teacher_dept='$teacher_dept' where teacher_id='$value'";
